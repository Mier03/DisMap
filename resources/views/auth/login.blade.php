<x-guest-layout>
    <div class="max-w-md w-full bg-white rounded-lg p-8 mx-auto">
        ...
        <div class="text-left mb-6">
            <h2 class="text-2xl font-bold text-teal-700">Welcome Back!</h2>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!-- Login Button -->
            <button type="submit" 
                class="w-full py-3 px-4 bg-teal-700 hover:bg-teal-800 text-white font-medium rounded-md transition duration-200">
                Sign In
            </button>
