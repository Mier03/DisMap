<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 ms-4">
                            Register
                        </a>
                    @endif
                @endauth
    ...
    <div :class="{'block': open, 'hidden': !open}" class="sm:hidden">
        <div class="pt-2 pb-1 border-t border-gray-200">
            ...
            @else
                <div class="px-4">
                    <a href="{{ route('login') }}" class="block w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-100 rounded">Log in</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="block w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-100 rounded mt-2">Register</a>
                    @endif
                </div>
            @endauth
        </div>
