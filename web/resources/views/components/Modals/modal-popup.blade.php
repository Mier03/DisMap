...
<div id="{{ $modalId }}" class="hidden fixed inset-0 bg-black bg-opacity-50 items-center justify-center z-50" data-update-route=" {{ $updateRoute ?? '' }} ">
    <div class="bg-white rounded-lg shadow-lg {{ $width }} p-8 text-left relative overflow-y-auto max-h-[90vh]">
        <div class="px-4 py-4">
